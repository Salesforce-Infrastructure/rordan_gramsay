require_relative '../../lib/rordan_gramsay/foodcritic/rule'

RSpec.describe RordanGramsay::Foodcritic::Rule do
  ...
  it 'can be printed in a pretty way' do
    expect(described_class.new(rule, false).to_s).not_to include '<RordanGramsay::Foodcritic::Rule'
  end
end
