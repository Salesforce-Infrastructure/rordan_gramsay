require_relative '../../lib/rordan_gramsay/rubocop/rule_list'

RSpec.describe RordanGramsay::Rubocop::RuleList do
  ...
  describe '#<<' do
    it 'transforms any non-rule into a rule' do
      ...
      expect(last_rule).to be_a RordanGramsay::Rubocop::Rule
    end
  ...
  describe '#failures?' do
    let(:internal_rule) { RordanGramsay::Rubocop::Rule }
